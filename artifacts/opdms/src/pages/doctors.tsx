...
import { Loader2, Calendar, Stethoscope, ChevronRight, MapPin, Phone, Mail, X } from "lucide-react";
                  ...
                  <div className="flex flex-col sm:flex-row overflow-y-auto">
                    ...
                    <div className="sm:w-56 shrink-0 bg-muted/30 border-b sm:border-b-0 sm:border-r p-6 flex flex-col items-center text-center">
                      ...
                      <button
                        ...
                        className="mt-6 w-full py-2.5 rounded-xl bg-foreground text-background font-semibold text-sm hover:bg-foreground/90 transition-colors"
                      >
                        Set an Appointment
                      </button>
                    </div>
