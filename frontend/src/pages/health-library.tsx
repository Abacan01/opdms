...
const DEFAULT_IMAGE = "https://images.unsplash.com/photo-1576671081837-49000212a370?w=800&q=80";

function getArticleImage(article: Article) {
  return article.imageUrl || DEFAULT_IMAGE;
}
    ...
    <Layout>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-card border rounded-2xl">
          ...
          <p className="text-muted-foreground mt-1">Check back later for new health resources.</p>
        </div>
      )}
